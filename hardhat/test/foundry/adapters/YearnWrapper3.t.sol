...
// contract YearnWrapperTest3 is AdapterTest {
    
//     using stdStorage for StdStorage;

//     YearnWrapper_v3 YearnAdapter;
//     address cryptFantom = 0xdCD90C7f6324cfa40d7169ef80b12031770B4325;
...
//         YearnAdapter = new YearnWrapper2(VaultAPI(cryptFantom));// = new YearnWrapper(0x4f086A048c33f3BF9011dd2265861ce812624f2c);
...
//         assertApproxEqRel(amount, assetsUsedtoMint, 0.00001e6, "Amount quoted does not match amount minted"); //Within .1% accuracy
...
//             assertApproxEqRel(asset.balanceOf(alice), aliceBalance + withdrawAmount, 0.00001e6, "Tokens not returned to alice from withdrawal");
...
//         assertApproxEqAbs(asset.balanceOf(alice), initAliceBalance, tolerance, "alice balance of assets not the same at the end of test");
//         assertApproxEqAbs(asset.balanceOf(address(adapter)), initadapterBalance, tolerance, "adapter balance is not same at end of test");
//         assertApproxEqRel(previewRedeem, shares_converted, 0.0001e6, "assets actually transferred to burn not same as quoted amount");
