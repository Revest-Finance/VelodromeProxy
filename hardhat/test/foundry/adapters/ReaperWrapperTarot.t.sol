...
contract ReaperWrapperTarotTest is GenericAdapterTest, Test {
    ...
    constructor() {
        ReaperAdapter = new ReaperWrapper(cryptFantom,DUST);
        vault = ReaperAdapter.vault();

        adapter = IERC4626(address(ReaperAdapter));
    ...
    */
    ...
    function testFailWithdrawAllowance(uint amount) external virtual {}
    function testMiscViewMethods(uint amount) external virtual {}
    function testWithdrawAllowance(uint amount) external virtual {}
