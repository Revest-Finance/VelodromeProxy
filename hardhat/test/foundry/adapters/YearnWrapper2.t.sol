...
import "contracts/adapters/yearn/YearnWrapperV2.sol";
...
contract YearnWrapperTest2 is GenericAdapterTest, Test {
    
    using stdStorage for StdStorage;

    YearnWrapperV2 YearnAdapter;
    ...
    constructor() {
        YearnAdapter = new YearnWrapperV2(VaultAPI(cryptFantom));// = new YearnWrapper(0x4f086A048c33f3BF9011dd2265861ce812624f2c);
        // console2.log("Adapter: ", address(YearnAdapter));
        vault = YearnAdapter.vault();
        
        adapter = IERC4626(address(YearnAdapter));
    ...
    */
    ...
    function testMiscViewMethods(uint amount) public virtual {
        ...
        uint maxRedeem = adapter.maxRedeem(alice);
