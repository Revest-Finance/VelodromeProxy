...
async function main() {
    ...
    //BOO Pool
    const yearnVault = "0x0fBbf9848D969776a5Eb842EdAfAf29ef4467698"

    const devWallet = "0xf5069D55CD518289f8063b0bd21e4E9981556c28"

    console.log(SEPERATOR);
    console.log("Deploying Yearn Adapter");

    // const YearnWrapperFactory = await ethers.getContractFactory("YearnWrapper")
    // const YearnWrapper = await YearnWrapperFactory.deploy(yearnVault);
    // await YearnWrapper.deployed();

    // console.log("Yearn Adapter: ", YearnWrapper.address)
    const YearnWrapper = "0xc8209F1d25c3CF8470cdFac8C025fcd7AfA8a685"

    await run("verify:verify", {
        address: YearnWrapper,
        constructorArguments: [yearnVault],
    })
