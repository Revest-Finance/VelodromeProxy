...
interface IResonate {
    ...
    function submitConsumer(bytes32 poolId, uint amount, bool shouldFarm) external;

    function modifyExistingOrder(bytes32 poolId, uint112 amount, uint64 position, bool isProvider) external;
